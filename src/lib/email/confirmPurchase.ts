...
<head>
  ...
  <title>Purchase Confirmation - Thank you for subscribing to ${SAAS_NAME}</title> 
  <style>
    @font-face {
                                      ...
                                      <div class="pc-font-alt" style="text-decoration: none;">
                                        <div
                                          ...
                                          <div><span
                                              ...
                                              class="pc-w620-font-size-30px pc-w620-line-height-133pc">Thank you for your purchase, ${name}!</span> </div>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
                                    ...
                                    <td valign="top" align="left">
                                      <div class="pc-font-alt" style="text-decoration: none;">
                                        <div
                                          ...
                                          <div><span style="font-family: 'Rubik', Arial, Helvetica, sans-serif;">By Victor
                                              Jaro</span> </div>
                                        </div>
                                      </div>
                                    </td>
